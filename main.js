    ...
    if (target === 'info') {
      ...
      dynamic.innerHTML = `
        <div class="info-block">
          <p>Kai Leah Sascha Krämer aka kitschkai aka Gender Panik is an artist & gender pirate, currently based in Leipzig. Coming from performance art, writing and literature studies, and informed deeply by trans*feminism, Punk and Drag, they examine how words and performances sustain power structures and where their potential for change lies. Recurring topics are norms regarding the body, its relationships to others and its emotions – and how they become places of sociopolitical agency. Here, they’re interested in laughter, joy and resistance. 
          Active on and behind the stage, they developed, collaborated and assisted in solo and group performances, theater productions, magazines plus making visual artworks, such as graphics and paintings.</p>
